...
class CouponCodesController extends Controller
{
    ...
    protected function form()
    {
        ...
        $form->radio('type', '类型')->options(CouponCode::$typeMap)->default(reset(CouponCode::$typeMap))->rules('required');
        ...
        $form->number('total', '总量')->default(0)->min(0)->rules('required|numeric|min:0');
